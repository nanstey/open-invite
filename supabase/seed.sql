...
-- Keep seed group setup compact and realistic:
-- 5 total groups, each with 3-15 members
...
INSERT INTO public.event_groups (event_id, group_id) VALUES
  -- e1: Bouldering at Crag X -> Rock Climbers
  ('10000000-0000-0000-0000-000000000001', '20000000-0000-0000-0000-000000000001'),
  
  -- e5: Deep Focus Study -> Tech Workers
  ('10000000-0000-0000-0000-000000000005', '20000000-0000-0000-0000-000000000002'),
  
  -- e14: Trivia Night -> Trivia Team
  ('10000000-0000-0000-0000-000000000014', '20000000-0000-0000-0000-000000000011'),
  
  -- e17: Code & Coffee -> Tech Workers
  ('10000000-0000-0000-0000-000000000017', '20000000-0000-0000-0000-000000000002'),
  
  -- e20: Book Club: Dune -> Book Club + Tech Workers
  ('10000000-0000-0000-0000-000000000020', '20000000-0000-0000-0000-000000000007'),
  ('10000000-0000-0000-0000-000000000020', '20000000-0000-0000-0000-000000000002'),
  
  -- e21: Airport Run (Pickup) -> Work Friends
  ('10000000-0000-0000-0000-000000000021', '20000000-0000-0000-0000-000000000004'),
  
  -- e22: Tech Meetup Downtown -> Tech Workers
  ('10000000-0000-0000-0000-000000000022', '20000000-0000-0000-0000-000000000002'),
  
  -- e41: Past Coding Session -> Tech Workers
...
-- Insert user groups
-- Keep memberships denser: 5 groups, each with 3-15 members
INSERT INTO public.user_groups (user_id, group_id, role) VALUES
  -- Rock Climbers (8 members)
  ...
  ('00000000-0000-0000-0000-000000000003', '20000000-0000-0000-0000-000000000001', 'MEMBER'),
  ('00000000-0000-0000-0000-000000000004', '20000000-0000-0000-0000-000000000001', 'MEMBER'),
  ('00000000-0000-0000-0000-000000000005', '20000000-0000-0000-0000-000000000001', 'MEMBER'),
  ('00000000-0000-0000-0000-000000000006', '20000000-0000-0000-0000-000000000001', 'MEMBER'),
  ('00000000-0000-0000-0000-000000000007', '20000000-0000-0000-0000-000000000001', 'MEMBER'),
  ('00000000-0000-0000-0000-000000000008', '20000000-0000-0000-0000-000000000001', 'MEMBER'),

  -- Tech Workers (12 members)
  ('00000000-0000-0000-0000-000000000001', '20000000-0000-0000-0000-000000000002', 'ADMIN'),
  ('00000000-0000-0000-0000-000000000002', '20000000-0000-0000-0000-000000000002', 'MEMBER'),
  ('00000000-0000-0000-0000-000000000003', '20000000-0000-0000-0000-000000000002', 'MEMBER'),
  ('00000000-0000-0000-0000-000000000004', '20000000-0000-0000-0000-000000000002', 'MEMBER'),
  ('00000000-0000-0000-0000-000000000005', '20000000-0000-0000-0000-000000000002', 'MEMBER'),
  ('00000000-0000-0000-0000-000000000006', '20000000-0000-0000-0000-000000000002', 'MEMBER'),
  ('00000000-0000-0000-0000-000000000007', '20000000-0000-0000-0000-000000000002', 'MEMBER'),
  ('00000000-0000-0000-0000-000000000008', '20000000-0000-0000-0000-000000000002', 'MEMBER'),
  ('00000000-0000-0000-0000-000000000009', '20000000-0000-0000-0000-000000000002', 'MEMBER'),
  ('00000000-0000-0000-0000-000000000010', '20000000-0000-0000-0000-000000000002', 'MEMBER'),
  ('00000000-0000-0000-0000-000000000011', '20000000-0000-0000-0000-000000000002', 'MEMBER'),
  ('00000000-0000-0000-0000-000000000012', '20000000-0000-0000-0000-000000000002', 'MEMBER'),

  -- Work Friends (10 members)
  ...
  ('00000000-0000-0000-0000-000000000004', '20000000-0000-0000-0000-000000000004', 'MEMBER'),
  ('00000000-0000-0000-0000-000000000005', '20000000-0000-0000-0000-000000000004', 'MEMBER'),
  ('00000000-0000-0000-0000-000000000006', '20000000-0000-0000-0000-000000000004', 'MEMBER'),
  ('00000000-0000-0000-0000-000000000007', '20000000-0000-0000-0000-000000000004', 'MEMBER'),
  ('00000000-0000-0000-0000-000000000008', '20000000-0000-0000-0000-000000000004', 'MEMBER'),
  ('00000000-0000-0000-0000-000000000009', '20000000-0000-0000-0000-000000000004', 'MEMBER'),
  ('00000000-0000-0000-0000-000000000010', '20000000-0000-0000-0000-000000000004', 'MEMBER'),

  -- Book Club (6 members)
  ('00000000-0000-0000-0000-000000000003', '20000000-0000-0000-0000-000000000007', 'ADMIN'),
  ('00000000-0000-0000-0000-000000000001', '20000000-0000-0000-0000-000000000007', 'MEMBER'),
  ('00000000-0000-0000-0000-000000000002', '20000000-0000-0000-0000-000000000007', 'MEMBER'),
  ...
  ('00000000-0000-0000-0000-000000000006', '20000000-0000-0000-0000-000000000007', 'MEMBER'),

  -- Trivia Team (6 members)
  ...
  ('00000000-0000-0000-0000-000000000002', '20000000-0000-0000-0000-000000000011', 'MEMBER'),
  ('00000000-0000-0000-0000-000000000003', '20000000-0000-0000-0000-000000000011', 'MEMBER'),
  ('00000000-0000-0000-0000-000000000004', '20000000-0000-0000-0000-000000000011', 'MEMBER'),
  ('00000000-0000-0000-0000-000000000005', '20000000-0000-0000-0000-000000000011', 'MEMBER')

  -- end of group memberships
