...
vi.mock('./eventService', () => ({ fetchEventById }))
...
describe('realtimeService', () => {
  it('subscribeToEvent fetches event on update and calls onDelete on delete', async () => {
    ...
    fetchEventById.mockResolvedValue({ id: 'event-1', reactions: {}, attendees: [], comments: [] })
  ...
  it('subscribeToReactions refetches event and calls callback', async () => {
    ...
    fetchEventById.mockResolvedValue({ id: 'event-1', reactions: { '🎉': { emoji: '🎉', count: 1, userReacted: false } } })
