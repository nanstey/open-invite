    ...
    const loadProfileData = async () => {
      try {
        ...
        if (attendeeData && attendeeData.length > 0) {
          ...
          const attended =
            eventsData?.filter((e: { id: string; host_id: string }) => e.host_id !== currentUser.id)
              .length || 0
    ...
    <div className="max-w-2xl mx-auto pb-20 pt-8 px-4 animate-fade-in">
      ...
      <div className="space-y-3">
        ...
        <div className="bg-surface rounded-xl border border-slate-700 overflow-hidden divide-y divide-slate-700/50">
          ...
          >
            <div className="flex items-center gap-3">
              <div className="p-2 bg-purple-500/10 rounded-lg text-slate-400">
          ...
          >
            <div className="flex items-center gap-3">
              <div className="p-2 bg-yellow-500/10 rounded-lg text-slate-400">
