    ...
    >
      ...
      <div className="px-4 pt-3 pb-2 relative">
        <div className="flex gap-3 items-center">
          ...
          <div
            className={`md:hidden relative p-2.5 rounded-lg border transition-all shadow-sm shrink-0 ${isStatusActive ? 'bg-primary/10 border-primary text-primary' : 'bg-slate-800 border-slate-700 text-slate-400'}`}
          >
