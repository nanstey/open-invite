    ...
    <SlidePanel title="Feedback Details" onClose={onClose}>
      ...
      <div>
        ...
        <div className="flex flex-wrap gap-2">
          <Badge colorClass={FEEDBACK_TYPE_COLORS[feedback.type]}>
            {feedback.type.toUpperCase()}
          </Badge>
          <Badge colorClass={FEEDBACK_IMPORTANCE_COLORS[feedback.importance]}>
            {feedback.importance.toUpperCase()}
          </Badge>
          <Badge colorClass={FEEDBACK_STATUS_COLORS[feedback.status]}>
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="bg-slate-800/50 rounded-xl p-4 border border-slate-700">
          ...
          <div className="text-sm text-white">{formatDateTime(feedback.createdAt)}</div>
        </div>
        <div className="bg-slate-800/50 rounded-xl p-4 border border-slate-700">
          <div className="flex items-center gap-2 text-slate-400 mb-1">
          ...
          <div className="text-sm text-white">{formatDateTime(feedback.updatedAt)}</div>
        </div>
      </div>
